...
namespace PPE3_genieco_v2
{
    ...
    public partial class genico_bdd_gsbEntities : DbContext
    {
        public genico_bdd_gsbEntities()
            : base("name=genico_bdd_gsbEntities")
        {
        }
        ...
        public virtual DbSet<montantRegion> montantRegion { get; set; }
    }
}
